...
void main() {
  group('Test not equal', () {
    ...
    test('Double != Double', () {
      ...
      final rightOperand = SyntaxLiteral.literalFromToken(Token(TokenType.numeralLiteral, '2.71'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
    ...
    test('String != String', () {
      final leftOperand = SyntaxLiteral.literalFromToken(Token(TokenType.stringLiteral, 'hello'));
      final rightOperand = SyntaxLiteral.literalFromToken(Token(TokenType.stringLiteral, 'world'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
    ...
    test('Same strings are equal -> != is false', () {
      final leftOperand = SyntaxLiteral.literalFromToken(Token(TokenType.stringLiteral, 'same'));
      final rightOperand = SyntaxLiteral.literalFromToken(Token(TokenType.stringLiteral, 'same'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
