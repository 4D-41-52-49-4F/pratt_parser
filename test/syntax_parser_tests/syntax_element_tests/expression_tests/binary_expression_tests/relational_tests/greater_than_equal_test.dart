...
void main() {
  group('Test greater-than-or-equal', () {
    ...
    test('Double greater than double evaluates correctly', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '3.1'));
    ...
    test('Int and double comparison evaluates correctly', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '4.5'));
      final rightOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '4'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
    ...
    test('Comparison with one value not num throws Exception', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '5'));
      final rightOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.stringLiteral, '3'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
  ...
  group('Greater-than-or-equal operator >= edge cases', () {
    final operator = SyntaxOperator.fromSymbol('>=') as BinaryOperator;
    ...
    test('Comparison with very small numbers', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '1e-307'));
    ...
    test('Comparison with very large negative numbers', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '-1e307'));
      final rightOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '-1e308'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
