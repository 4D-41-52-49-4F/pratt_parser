...
void main() {
  group('Test division', () {
    ...
    test('Division with double evaluates to double.', () {
      final leftOperand = SyntaxLiteral.literalFromToken(Token(TokenType.numeralLiteral, '3.0'));
    ...
    test('Division with 0 as dividend evaluates to 0.', () {
      ...
      final rightOperand = SyntaxLiteral.literalFromToken(Token(TokenType.numeralLiteral, '2700'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
    ...
    test('Division with divisor 0 throws Exception.', () {
      final leftOperand = SyntaxLiteral.literalFromToken(Token(TokenType.numeralLiteral, '3'));
      final rightOperand = SyntaxLiteral.literalFromToken(Token(TokenType.stringLiteral, '0'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
