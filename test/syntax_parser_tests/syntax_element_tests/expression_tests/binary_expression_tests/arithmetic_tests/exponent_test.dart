...
void main() {
  group('Test exponent operator', () {
    ...
    test('Exponent with integer base and double exponent evaluates to double value.', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '9'));
    ...
    test('Exponent with very large numbers evaluates to infitinite. (Exceeding double.maxFinite).', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '1.8e154'));
    ...
    test('Exponent with very small numbers evaluates correctly.', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '1e-154'));
      final rightOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '2'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
      final result = expression.evaluate();
  ...
  group('Test edge cases of dart:math pow(num base, num exponent) function in relation to exponent operator.', () {
    ...
    test('base is 1.0 → result is 1.0', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '1.0'));
      final rightOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '12345'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
    ...
    test('exponent is Infinity and |base| < 1 → result is 0.0', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '0.5'));
    ...
    test('exponent is Infinity and |base| > 1 → result is Infinity', () {
      final leftOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '2.0'));
      final rightOperand = SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '${double.infinity}'));
      final expression = BinaryExpression(operator: operator, leftOperand: leftOperand, rightOperand: rightOperand);
