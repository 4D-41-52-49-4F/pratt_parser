  ...
  group('Test logical OR (||)', () {
    ...
    test('Complex expressions as operands', () {
      final leftOperand = BinaryExpression(
        ...
        leftOperand: SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '5')),
        rightOperand: SyntaxLiteral.literalFromToken(const Token(TokenType.numeralLiteral, '10')),
      );
